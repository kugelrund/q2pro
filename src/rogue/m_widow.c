...
//		gi.dprintf ("%2.2f -> ", enemy_yaw);
	...
	else if (enemy_yaw >= 85.0)
		return FRAME_fired04;
	else if (enemy_yaw >= 75.0)
		return FRAME_fired05;
	else if (enemy_yaw >= 65.0)
		return FRAME_fired06;
	else if (enemy_yaw >= 55.0)
		return FRAME_fired07;
	else if (enemy_yaw >= 45.0)
		return FRAME_fired08;
	else if (enemy_yaw >= 35.0)
		return FRAME_fired09;
	else if (enemy_yaw >= 25.0)
		return FRAME_fired10;
	else if (enemy_yaw >= 15.0)
		return FRAME_fired11;
	else if (enemy_yaw >= 5.0)
